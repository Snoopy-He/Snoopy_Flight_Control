...
local trottle = 80
function Motor1_Set()
    Motor1.setTargetSpeed(-trottle+80)
end

function Motor2_Set()
    Motor2.setTargetSpeed(trottle-80)
end
...
while true do
    ...
    Yaw_Angle = Yaw_Angle + omega.y/20
    Pitch_Angle = Pitch_Angle + omega.x/20
    Roll_Angle = Roll_Angle + omega.z/20
